 ...
 * @author Lenovo
 */
public class ListLanguesController implements Initializable {
    ...
    private List<Langue> displaylist;
    
    private List<Langue> listlangues;
        ...
        btnAdd.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                try {
                    ...
                    SceneLoader.getInstance().NavigateTo(window, "addLangue");  
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
        ...
        for (int i = 0; i < displaylist.size(); i++) {
            ...
            btne.setOnAction((ActionEvent event) -> {
                ...
                try {
                    ...
                    SceneLoader.getInstance().setLangueId(Integer.parseInt(btn.getId().substring(1)));
                    Window window = btne.getScene().getWindow();
                    SceneLoader.getInstance().NavigateTo(window, "UpdateLangue");  
...
//            btnd.setGraphic(view);
            ...
            btnd.setOnAction((ActionEvent event) -> {
                ...
                try {
                    sl.deleteLangue(Integer.parseInt(btn.getId().substring(1)));
                    Langue b = displaylist.get(Integer.parseInt(btn.getId().substring(1)));
                    //displaylist.remove(Integer.parseInt(btn.getId().substring(1)));
                    listlangues.remove(b);
                    displaylist = listlangues;
                    afficher();
    ...
    public void getListeners(){
        ...
        fname.textProperty().addListener((observale, oldtext, newtext)->{
            ...
            if(!(newtext == null || newtext.equals(""))){
                displaylist = listlangues.stream()
